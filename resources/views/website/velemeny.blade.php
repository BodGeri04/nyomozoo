...
@section('content')
    ...
    <!--================================
        ...
        =================================-->
    @if ($mode == 'create')
        <form method="POST" id="velemeny" action="{{ route('velemeny.store') }}" enctype="multipart/form-data">
            @csrf
    @endif
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <div class="col-md-9">
                    <h2>A Nyomozoo.hu csapatának fontos a felhasználói vélemény.</h2>
                    <h3 class="pt-3 pb-9">Hálásak lennénk ha megosztanád velünk véleményed és tapasztalatodat az
                        oldallal kapcsolatban.</h3>
                    <label>* A véleményezés {{ Auth::user()->name }} nevű felhasználóval kizárólag egyszer érhető
                        el! *</label>
                    <textarea name="feedback_description" rows="3"
                        placeholder="Amennyiben szeretnéd bővebben kifejteni véleményedet, írd ide."
            ...
            <br>
            <hr>
            <input type="submit" class="btn btn-primary btn--loading aling-bottom d-flex" value="Mentés" />
        </div>
    </section>
    </form>
    <!-- contact us end -->
